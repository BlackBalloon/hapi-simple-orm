...
(function() {
  ...
  BaseView = (function() {
    ...
    BaseView.prototype.getBasicConfiguration = function(arg) {
      var description, id, many, method, params, path, payload, query, ref, responses;
      ref = arg != null ? arg : {}, method = ref.method, description = ref.description, id = ref.id, path = ref.path, many = ref.many, params = ref.params, responses = ref.responses, payload = ref.payload, query = ref.query;
      return {
        method: method,
        path: path,
        config: {
