          ...
          handler: (function(_this) {
            return function(request, reply) {
              ...
              return _this.config.model.objects().create({
                ...
                var currentModelCollection, insertData, serializerClass, serializerInstance, whoCreated;
                if ((_this.config.mongoConf != null) && (_this.config.mongoConf.mongoInstance != null)) {
                  whoCreated = request.auth.credentials != null ? request.auth.credentials.user : 'undefined';
                  insertData = {
              ...
              return _this.config.model.objects()["delete"](request.params.id, whoDeleted).then(function(result) {
                ...
                if (result === 1) {
                  if ((_this.config.mongoConf != null) && (_this.config.mongoConf.mongoInstance != null)) {
                    ...
                    whoDeleted = request.auth.credentials != null ? request.auth.credentials.user : 'undefined';
                    deleteData = {
                      model: _this.config.model.metadata.model,
                      module: _this.config.mongoConf.module || 'undefined',
