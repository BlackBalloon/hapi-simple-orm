          ...
          handler: (function(_this) {
            return function(request, reply) {
              ...
              if (request.query.fields != null) {
                if (_this.config.allowTimestampAttributes == null) {
                  _.each(returning, function(fieldName) {
                    if (fieldName in _this.config.model.prototype.timestampAttributes) {
                      return reply(Boom.badRequest("Field " + fieldName + " is not attribute of model " + _this.config.model.metadata.model));
                    }
                  });
                }
