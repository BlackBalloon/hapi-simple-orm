    ...
    ModelView.prototype.update = function(ifSerialize, serializer, options) {
      ...
      routeObject = {
        ...
        config: {
          ...
          validate: {
            params: this.config.model.prototype.attributes[this.config.model.metadata.primaryKey].attributes.schema.required(),
            payload: this.config.model.getSchema()
          },
          plugins: {
            'hapi-swagger': {
            ...
            return function(request, reply) {
              return _this.config.model.objects().getById({
                ...
                if (instance != null) {
                  ...
                  return instance.save().then((function(_this) {
                  ...
                  return reply(Boom.notFound(this.config.errorMessages.notFound || (this.config.model.metadata.model + " does not exist")));
                }
              });
            };
          })(this)
