...
(function() {
  ...
  ModelView = (function(superClass) {
    ...
    ModelView.prototype._validateReturningFields = function(fields, reply) {
      var returningArray;
      returningArray = _.clone(fields);
      if (!this.config.allowTimestampAttributes) {
        returningArray = _.difference(fields, _.keys(this.config.model.prototype.timestampAttributes));
      }
        ...
        config: {
          ...
          handler: (function(_this) {
            return function(request, reply) {
              var returning;
              returning = request.query.fields != null ? _this._validateReturningFields(request.query.fields) : void 0;
              return _this.config.model.objects().getById({
                pk: request.params.id,
                returning: returning
              }).then(function(result) {
                var serializerClass, serializerInstance;
                if ((result != null) && ifSerialize) {
                ...
                } else if ((result != null) && !ifSerialize) {
                  return reply(result);
                } else if (result == null) {
    ...
    ModelView.prototype.list = function(ifSerialize, serializer, options) {
      ...
      routeObject = {
        ...
        config: {
          ...
          handler: (function(_this) {
            return function(request, reply) {
              var daoOperation, returning;
              returning = request.query.fields != null ? _this._validateReturningFields(request.query.fields) : void 0;
              if ((request.query.limit != null) && (request.query.page != null)) {
                daoOperation = _this.config.model.objects().filterPaged({
                  returning: returning,
                ...
                daoOperation = _this.config.model.objects().all({
                  returning: returning
                });
              }
              return daoOperation.then(function(objects) {
                var serializerClass, serializerInstance;
                if (ifSerialize) {
                  serializerClass = serializer ? serializer : _this.config.serializer;
                  if (serializerClass == null) {
          ...
          handler: (function(_this) {
            return function(request, reply) {
              ...
              return _this.config.model.objects().create({
                ...
                var currentModelCollection, insertData, serializerClass, serializerInstance;
                if ((_this.config.mongoConf != null) && (_this.config.mongoConf.mongoInstance != null)) {
                  insertData = {
                    model: _this.config.model.metadata.model,
                    module: _this.config.mongoConf.module || 'undefined',
                    whoPerformed: request.auth.credentials != null ? request.auth.credentials.user : 'undefined',
                    action: 'create',
                    payload: request.payload,
                    actionDate: new Date(),
                    userAgent: request.orig.headers['user-agent']
                  };
                  currentModelCollection = _this.config.mongoConf.mongoInstance.db().collection(_this.config.model.metadata.collectionName);
                  currentModelCollection.insert(insertData, function(error, value) {
                    if (error && (_this.config.model.objects().errorLogger != null)) {
                      return _this.config.model.objects().errorLogger.error(error);
                    }
                  });
                }
                if (ifSerialize) {
              ...
              return _this.config.model.objects().getById({
                ...
                if (instance != null) {
                  previousData = instance.toJSON({
                    attributes: _this.config.model.prototype.fields
                  });
                  ...
                  return instance.save().then(function(result) {
                    ...
                    if ((_this.config.mongoConf != null) && (_this.config.mongoConf.mongoInstance != null)) {
                      insertData = {
                        ...
                        module: _this.config.mongoConf.module || 'undefined',
                        whoPerformed: request.auth.credentials != null ? request.auth.credentials.user : 'undefined',
                        action: request.route.method === 'put' ? 'update' : 'partialUpdate',
                        payload: request.payload,
                      ...
                      currentModelCollection = _this.config.mongoConf.mongoInstance.db().collection(_this.config.model.metadata.collectionName);
                      currentModelCollection.insert(insertData, function(error, value) {
                        if (error && (_this.config.model.objects().config.errorLogger != null)) {
                          return _this.config.model.objects().config.errorLogger.error(error);
                        }
                      });
                    }
                    if (ifSerialize) {
          ...
          handler: (function(_this) {
            return function(request, reply) {
              ...
              return _this.config.model.objects()["delete"](request.params.id, whoDeleted).then(function(result) {
                var currentModelCollection, deleteData, deleteDataSpecifics, publishObj;
                if (result === 1) {
                  if ((_this.config.mongoConf != null) && (_this.config.mongoConf.mongoInstance != null)) {
                    deleteDataSpecifics = {};
                    deleteDataSpecifics[_this.config.model.metadata.primaryKey] = request.params.id;
                    deleteData = {
                      model: _this.config.model.metadata.model,
                      module: _this.config.mongoConf.module || 'undefined',
                      whoPerformed: request.auth.credentials != null ? request.auth.credentials.user : 'undefined',
                    ...
                    currentModelCollection = _this.config.mongoConf.mongoInstance.db().collection(_this.config.model.metadata.collectionName);
                    currentModelCollection.insert(deleteData, function(error, value) {
                      if (error && (_this.config.model.objects().config.errorLogger != null)) {
                        return _this.config.model.objects().config.errorLogger.error(error);
                      }
                    });
