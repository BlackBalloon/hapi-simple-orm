...
(function() {
  'use strict';
  var ForeignKey, Promise, Serializer, _,
  ...
  Serializer = (function() {
    ...
    function Serializer() {
      ...
      if (this.constructor.config.fields.length === 0 && this.constructor.config.readOnlyFields.length === 0) {
        this.serializerFields = _.keys(this.constructor.config.model.prototype.attributes);
      } else {
      ...
      _.each(this.serializerFields, (function(_this) {
        return function(val, key) {
          if (typeof val === 'string' && (_this.constructor.config.model.prototype.attributes[val] == null)) {
