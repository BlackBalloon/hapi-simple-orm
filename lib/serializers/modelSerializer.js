...
(function() {
  ...
  ModelSerializer = (function(superClass) {
    ...
    function ModelSerializer(arg) {
      ...
      if ((this.data != null) && !this.many && !(this.data instanceof this.config.model)) {
        throw new Error("Data passed to the " + this.constructor.name + " must be an instance of " + this.config.model.metadata.model + "!");
      } else if ((this.data != null) && this.many) {
        if ((_.filter(this.data, (function(_this) {
          return function(val) {
            return val instanceof _this.config.model;
          };
      ...
      if (this.instance != null) {
        if (!(this.instance instanceof this.config.model)) {
          throw new TypeError("Instance passed to the " + this.constructor.name + " is not an instance of " + this.config.model.name);
        }
      }
    }
    ...
    ModelSerializer.prototype._getSingleObject = function(obj) {
      ...
      _.each(this.serializerFields, (function(_this) {
        return function(val, key) {
          ...
          if (!(indexOf.call(_this.config.excludeFields, key) >= 0) && key in obj.attributes) {
        ...
        return function(resolve, reject) {
          _.each(_this.data, function(val, key) {
            if (!(indexOf.call(_this.serializerFieldsKeys, key) >= 0)) {
              return reject(new TypeError(("Parameter '" + key + "' is not an attribute of ") + (_this.config.model.metadata.model + " or is set as readOnly!")));
            }
          });
          if (_this.config.model.metadata.primaryKey in _this.data && !_this.instance) {
    ...
    ModelSerializer.prototype.create = function() {
      return this.config.model.objects().create({
        data: this.data,
        toObject: true
        ...
        return function(error) {
          if (_this.config.model.metadata.errorLogger != null) {
            _this.config.model.metadata.errorLogger.error(error);
          }
          throw error;
        };
      })(this));
    ...
    ModelSerializer.prototype.update = function() {
      if (this.instance == null) {
        throw new Error("There is no instance of " + this.config.model.metadata.model + "!");
      }
