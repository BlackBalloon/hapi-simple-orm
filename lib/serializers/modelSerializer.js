...
(function() {
  'use strict';
  var BaseModel, FieldRelatedSerializer, ForeignKey, ManyToMany, ManyToOne, ModelSerializer, PrimaryKeyRelatedSerializer, Promise, Serializer, _, debug, knex, knexConf, methods,
