...
(function() {
  ...
  BaseField = (function() {
    ...
    BaseField.acceptedParameters = ['required', 'unique', 'schema', 'initialSchema', 'dbField', 'abstract', 'name', 'primaryKey', 'modelMeta', 'errorMessages', 'set', 'get'];
    ...
    BaseField.prototype.validateUnique = function(value, arg) {
      var bindings, finalQuery, lookup, omitDeleted, primaryKey, query, self, trx;
      primaryKey = arg.primaryKey, trx = arg.trx;
      lookup = {};
      lookup[this.attributes.dbField] = value;
      omitDeleted = {
        is_deleted: false
      };
      self = this;
