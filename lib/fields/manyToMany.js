  ...
  ManyToMany = (function() {
    ...
    ManyToManyManager = (function() {
      function ManyToManyManager(obj1, name, field) {
        ...
        this.thisModel = this.obj.constructor.metadata;
      ...
      ManyToManyManager.prototype.all = function(arg) {
        ...
        return knex(this.toModel.metadata.tableName).select(this.returning).leftJoin(this.through, this.toModel.metadata.tableName + "." + this.toModel.metadata.primaryKey, this.through + "." + this.throughFields[1]).where(this.through + "." + this.throughFields[0], this.obj[this.obj.constructor.metadata.primaryKey]).andWhere(this.toModel.metadata.tableName + ".is_deleted", false).then((function(_this) {
