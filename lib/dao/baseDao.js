...
(function() {
  ...
  BaseDAO = (function() {
    BaseDAO.extendWithModel = function(model) {
      var newReturning, ref, returningArray;
      if (this.config == null) {
        this.config = {};
      }
      ...
      _.each(this.config.returning, (function(_this) {
        return function(returningArray, key) {
          var newReturningArray;
          newReturningArray = _.map(returningArray, function(fieldName) {
            return (_this.config.model.prototype.attributes[fieldName].getDbField(fieldName)) + " AS " + fieldName;
          });
          return newReturning[key] = newReturningArray;
        };
      })(this));
      this.config.returning = newReturning;
      this.config.model.injectDao(this);
      if ((ref = model.extended) != null) {
        ref.apply(this);
      }
      return this;
    };
    ...
    function BaseDAO(model, errorLogger) {
      var newReturning, returningArray;
      if (this.config == null) {
        this.config = {};
      }
      this.config.model = model;
      ...
      _.each(this.config.returning, (function(_this) {
        return function(returningArray, key) {
          var newReturningArray;
          newReturningArray = _.map(returningArray, function(fieldName) {
            if (!([" AS "].some(function(word) {
              return ~fieldName.indexOf(word);
            }))) {
              return (_this.config.model.prototype.attributes[fieldName].getDbField(fieldName)) + " AS " + fieldName;
            } else {
              return "" + fieldName;
    ...
    BaseDAO.getById = function(arg) {
      var pk, ref, returning, toObject;
      ...
      return knex(this.config.model.metadata.tableName).where(this.config.model.metadata.primaryKey, pk).andWhere('is_deleted', false).select(returning).then((function(_this) {
    ...
    BaseDAO.get = function(arg) {
      var lookup, ref, returning, toObject, where;
      ...
      return knex(this.config.model.metadata.tableName).where(where).andWhere('is_deleted', false).select(returning).then((function(_this) {
        return function(rows) {
          if (rows.length > 1) {
    ...
    BaseDAO.all = function(arg) {
      var column, knexQuery, orderBy, ref, ref1, returning, toObject;
    ...
    BaseDAO.filter = function(arg) {
      var column, lookup, model, orderBy, query, ref, ref1, returning, toObject;
    ...
    BaseDAO.create = function(arg) {
      var data, direct, instance, ref, returning, toObject, validationPromise;
      ...
      return Promise.all([validationPromise]).then((function(_this) {
        return function(validationErrors) {
          ...
          return knex(_this.config.model.metadata.tableName).insert(data, returning).then(function(rows) {
    ...
    BaseDAO.bulkCreate = function(arg) {
    ...
    BaseDAO["delete"] = function(lookupValue, whoDeleted) {
