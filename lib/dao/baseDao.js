...
(function() {
  ...
  BaseDAO = (function() {
    ...
    BaseDAO.prototype.get = function(arg) {
      ...
      ref = arg != null ? arg : {}, where = ref.where, lookup = ref.lookup, returning = ref.returning, toObject = ref.toObject;
      if (toObject == null) {
        toObject = true;
      }
      if (where == null) {
    ...
    BaseDAO.prototype.all = function(arg) {
      ...
      return knex(this.config.model.metadata.tableName).select(returning).andWhere('is_deleted', false).then((function(_this) {
        return function(rows) {
    ...
    BaseDAO.prototype.filter = function(arg) {
      var lookup, query, ref, returning, toObject;
