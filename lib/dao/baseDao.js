...
(function() {
  ...
  BaseDAO = (function() {
    ...
    BaseDAO.prototype.create = function(arg) {
      var data, direct, insertData, instance, ref, returning, toObject, validationPromise;
      ...
      return Promise.all([validationPromise]).then((function(_this) {
        return function(validationErrors) {
          ...
          return knex(_this.config.model.metadata.tableName).insert(insertData, returning).then(function(rows) {
