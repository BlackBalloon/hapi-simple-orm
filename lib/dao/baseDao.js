        ...
        return function(returningArray, key) {
          ...
          newReturningArray = _.map(returningArray, function(fieldName) {
            if (!([" AS "].some(function(word) {
              ...
              if (!(fieldName in _this.config.model.prototype.attributes)) {
                throw new Error("Field '" + fieldName + "' from 'config.returning' of " + _this.config.model.metadata.model + " is not an attribute of this model");
              }
